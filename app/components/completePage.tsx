...
type Status = "succeeded" | "processing" | "requires_payment_method" | "default";
...
const STATUS_CONTENT_MAP: Record<Status, StatusContent> = {
  succeeded: {
...
const CompletePage = () => {
  ...
  React.useEffect(() => {
    ...
    stripe.retrievePaymentIntent(clientSecret).then(({ paymentIntent }) => {
      ...
      setStatus(paymentIntent.status as Status);
