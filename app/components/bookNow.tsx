    ...
    <div id="book" className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-[#003b73] mb-4">
            ...
            <div className="sticky top-8 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="space-y-3 pb-4 border-b">
                  ...
                  {bookingDate && (
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-gray-900">{formatDateForDisplay(bookingDate)}</span>
                    </div>
                  )}
                  {pickupTime && (
                    <div className="flex justify-between items-center">
                ...
                <div className="pt-4 border-t">
                  <h4 className="text-sm font-semibold text-gray-700 mb-3">Apply Discount Code</h4>
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#003b73] focus:border-transparent"
                    />
                    <button
                      onClick={applyDiscount}
                      disabled={discountLoading || !discountCode.trim()}
                      className="px-4 py-2 text-sm bg-[#003b73] text-white rounded-lg hover:bg-[#005a8e] disabled:opacity-50 disabled:cursor-not-allowed transition"
                    >
                      {discountLoading ? (
            ...
            <div className="mt-6 bg-white rounded-xl shadow-md border border-gray-100 p-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center text-sm">
                  ...
                  <span className="text-gray-700">support@caribbeanadventures.com</span>
                </div>
              </div>
            </div>
          </div>
