...
export default async function WaterSportsSection() {
  ...
  const waterSports: waterSports[] = data?.waterSports || [];
  return (
    <section id="water" className="bg-white py-6 md:py-16 px-4">
      {/* Section Header */}
        ...
        {waterSports.map((sport, index) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-blue-800 font-bold mt-2">{sport.price}</p>
            </div>
          </div>
        ))}
      </div>
